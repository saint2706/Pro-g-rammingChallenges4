...
def main() -> None:
    parser = argparse.ArgumentParser(description="Roguelike dungeon crawler built with tcod.")
    parser.add_argument("--load", dest="load", default=None, help="Load a saved game file.")
    parser.add_argument("--tileset", dest="tileset", default=None, help="Path to a custom .ttf tileset.")
