...
def render() -> None:
    ...
    with col1:
        vector1_text = st.text_input(
            "Vector 1", value=default_v1, help="Comma or space separated"
        )
    with col2:
        vector2_text = st.text_input(
            "Vector 2", value=default_v2, help="Comma or space separated"
        )
