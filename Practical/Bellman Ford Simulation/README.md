...
```
Practical/Bellman Ford Simulation/
...
> Activate your virtual environment and install dependencies first (see `Practical/requirements.txt`). Matplotlib is required for the GUI, pandas is only needed if you want to post-process CSV exports.

### Launch the Visual Simulation

```bash
python "Practical/Bellman Ford Simulation/bellman_ford_simulation.py" \
    --input "Practical/Bellman Ford Simulation/sample_graph.json" \
    --start A
```
