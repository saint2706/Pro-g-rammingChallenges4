...
class TcpServerConfig:
    host: str = "127.0.0.1"
    port: int = 8765
    log_path: Path = Path("Practical/Chat Server Client/logs/tcp-chat.log")
...
class TcpClientConfig:
    ...
    port: int = 8765
    room: str = "lobby"
    log_path: Path = Path("Practical/Chat Server Client/logs/tcp-client.log")
...
class UdpConfig:
    host: str = "127.0.0.1"
    port: int = 8766
    log_path: Path = Path("Practical/Chat Server Client/logs/udp-chat.log")
