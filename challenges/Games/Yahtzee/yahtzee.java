...
/**
 * A simple command-line Yahtzee game for one player. Demonstrates dice rolling, rerolling, and
 * scoring logic for educational purposes.
 *
 * <p>Modernized, documented, and optimized for clarity and maintainability.
 */
public class Yahtzee {
  /**
   * Main entry point for the Yahtzee game. Handles game loop, dice rolling, rerolling, and scoring.
   */
  public static void main(String[] args) {
    ...
    while (play == 1 && filledCategories < 15) {
      ...
      for (int cat : usedCategories) filledCategories += cat;
  ...
  /**
   * Prompt the user for an integer input within a specified range. Handles invalid input
   * gracefully.
   */
...
class Winnings {
  ...
  /**
   * Prompts the user to select a scoring category, checks if the dice match, and updates the score.
   *
  ...
  public void checkWinnings(int[] dice, int[] usedCategories) {
    ...
    String[] categories = {
      "Yahtzee", "Full House", "Large Straight", "Small Straight", "Four of a Kind",
          "Three of a Kind",
